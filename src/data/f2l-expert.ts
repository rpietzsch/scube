...
export const F2L_EXPERT_CASES: CaseData[] = [
  ...
  { id: 'af2l-8',  stage: 'f2lExpert', group: 'trappedCorner', name: 'AF2L 8',  context: CTX, solve: "U' F' U2 L U L' F" },
  ...
  { id: 'af2l-4a', stage: 'f2lExpert', group: 'trappedCorner', name: 'AF2L 4a', context: CTX, solve: "U R U R2 U2 R" },
  ...
  { id: 'af2l-7a', stage: 'f2lExpert', group: 'trappedCorner', name: 'AF2L 7a', context: CTX, solve: "U2 R U' R' U2 R' U R" },
  ...
  { id: 'af2l-12',  stage: 'f2lExpert', group: 'trappedEdge', name: 'AF2L 12',  context: CTX, solve: "U2 R U R' L' U L" },
  { id: 'af2l-13',  stage: 'f2lExpert', group: 'trappedEdge', name: 'AF2L 13',  context: CTX, solve: "U R' F R F' R' U' R" },
  { id: 'af2l-14',  stage: 'f2lExpert', group: 'trappedEdge', name: 'AF2L 14',  context: CTX, solve: "U' F R' F' R U L U L'" },
  ...
  { id: 'af2l-17',  stage: 'f2lExpert', group: 'trappedEdge', name: 'AF2L 17',  context: CTX, solve: "U2 R B' U' B R'" },  // skip leading y
  { id: 'af2l-18',  stage: 'f2lExpert', group: 'trappedEdge', name: 'AF2L 18',  context: CTX, solve: "U F' U2 F L' U' L" },
  ...
  // ============================================================
  { id: 'af2l-25', stage: 'f2lExpert', group: 'bothPiecesTrapped', name: 'AF2L 25', context: CTX, solve: "F' U R' U2 R F" },
  { id: 'af2l-26', stage: 'f2lExpert', group: 'bothPiecesTrapped', name: 'AF2L 26', context: CTX, solve: "L R U2 R' L'" },
  ...
  { id: 'af2l-29', stage: 'f2lExpert', group: 'bothPiecesTrapped', name: 'AF2L 29', context: CTX, solve: "F' U L' U L U' L U L' F" },
  ...
  { id: 'af2l-34', stage: 'f2lExpert', group: 'bothPiecesTrapped', name: 'AF2L 34', context: CTX, solve: "F' R U R U' R U' R F" },
  ...
  { id: 'af2l-38', stage: 'f2lExpert', group: 'bothPiecesTrapped', name: 'AF2L 38', context: CTX, solve: "R U' R' U R U2 R' L U2 L'" },
